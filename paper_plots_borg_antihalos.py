...
ax2.imshow(combPercentile99Rand_Interp((X,Y)).T,vmin=0,vmax=1.0,cmap=cmap,\
...
c2 = ax2.contour(X,Y,combPercentile99Rand_Interp((X,Y)),[0.02,0.03],\
    colors=['k','k','k'])
...
sm = cm.ScalarMappable(colors.Normalize(vmin=0.0,vmax=0.3),\
    cmap=cmap)
